const images = [
  { text: 'みなさん、私のシンプルなウェブサイトへようこそ。これは、イスラムの奇跡を紹介し、なぜイスラムがあなたにとって正しい選択なのかを非常にシンプルに説得するためのものです。\nこのウェブサイトでは、クルアーン（イスラムの聖典）に記載された多くの奇跡や、現代科学がその正確性を証明した方法をご覧いただけます。\n右矢印をクリックして、始めましょう。\nこのクルアーンが1600年前に砂漠で紹介されたことを常に心に留めておいてください。ですので、ここでいくつかの奇跡があなたにとって些細に見えるかもしれませんが、常にこれが古代に書かれたものであることを忘れないでください。' },
  { text: '<div class="quran-quote">天と，ノック者によって（誓う）。<br>ノック者が何であるかを，あなたに理解させるものは何か。<br>（それは）きらめき輝く星。</div>' +
...
'<p><a href="https://ja.wikipedia.org/wiki/%E5%9B%BD%E5%88%A5%E6%9C%80%E4%BD%8E%E6%A8%99%E9%AB%98%E5%9C%B0%E7%82%B9%E3%81%AE%E4%B8%80%E8%A6%A7#:~:text=%E3%82%A4%E3%82%B9%E3%83%A9%E3%82%A8%E3%83%AB%E3%81%A8%E3%83%A8%E3%83%AB%E3%83%80%E3%83%B3%E3%81%AB%E3%81%BE%E3%81%9F%E3%81%8C%E3%82%8B,%E3%81%8C%E4%BD%8E%E3%81%84%E5%9C%B0%E7%82%B9%E3%81%A7%E3%81%82%E3%82%8B%E3%80%82" target="_blank" rel="noopener noreferrer">参考</a></p>' },
  { text: '<div class="quran-quote">75.わたしは，沈んでゆく星にかけて誓う。<br>76.それは本当に偉大な誓いである。もしあなたがたに分るならば，</div>' +
...
'<p><a href="https://phys.org/news/2023-08-simulations-black-holes-one-tenth.html#:~:text=23-,Simulations%20suggest%20some%20black%20holes%20could%20be%20moving%20at%20nearly,tenth%20the%20speed%20of%20light&text=A%20pair%20of%20astrophysicists%20at,tenth%20the%20speed%20of%20light." target="_blank" rel="noopener noreferrer">参考</a></p>' },
  { text: '<div class="quran-quote">われは誓う、隠れる諸星に。それらはいずれ現れる。<br>そして軌道を走り、そして暁と共に沈むもの。それは、自分の穴に戻るガゼルのようなもの。</div>' +
...
'<p>アッラーはここで、２つの海が交わる地点を描写しています。視覚的には同じように見えますが、実際には混ざっていません。現代の科学は、海と川の交わる地点が水の性質の違いから完全に混ざっていないことを証明しました。空から見ると、それは非常に明確です。</p>' },
  { text: '<div class="quran-quote">また、かれらへの唯一性の印の1つには、太陽がある。それはアッラーの定めに従って、ある一点までは動いて、それ以上を越えることはない。それは偉大なお方の定めであり誰の挑戦も受けず、そのお方からは何事も隠すことはできないのである。</div>' +
...
'<p><a href="https://science.nasa.gov/sun/facts/" target="_blank" rel="noopener noreferrer">参考</a></p>' },
  { text: '<div class="quran-quote">アッラーを否定する者たちは、諸天と大地がかつて重なり合っていて、隙間なくそこから雨が降っていたのをわれらが両者をわけ、天から地へ降る雨によりすべての動植物をつくったのを知らないのか。それを考慮してアッラーのみを信じようとはしないのか。</div>' +
...
'<p><a href="http://www.lap.c.u-tokyo.ac.jp/ja/theme_lectures/water/131127/#:~:text=%E7%94%9F%E7%89%A9%E3%81%AB%E3%81%A8%E3%81%A3%E3%81%A6%E6%B0%B4%E3%81%8C%E4%B8%8D%E5%8F%AF%E6%AC%A0,%E3%82%82%E9%87%8D%E8%A6%81%E4%BA%8B%E3%81%A7%E3%81%82%E3%82%8B%E3%80%82" target="_blank" rel="noopener noreferrer">参考</a></p>' },
  { text: '<div class="quran-quote">諸天をわれらは打ち立て、力によってその構築を完全なものとした。われらはその両端をさらに広げよう。</div>' +
...
'<p><a href="https://gigazine.net/news/20230120-universe-expanding/" target="_blank" rel="noopener noreferrer">参考</a></p>' },
  { text: '<div class="quran-quote">かれはあなたがたを一つの魂から創り，それからその配偶者を創り，またかれは8頭の家畜を雌雄であなたがたに遣わされた。かれはあなたがたを母の胎内に創られ，3つの暗黒の中において，創造につぐ創造をなされた。このように，あなたがたの主アッラーに大権は属する。かれの外に神はないのである。なのにあなたがたはどうして背き去るのか。</div>' +
...
'<p>クルアーンがここで議論している3つの種類の暗黒は何ですか？答えはかなり興味深いです。胎児の暗黒、その中に胎児がある胎盤の暗黒、そして腹部の暗黒、女性の腹部です。</p>' },
  { text: '<div class="quran-quote">それからまだ煙（のよう）であった天に転じられた。そして天と地に向かって，『両者は，好むと好まざるとに関わらず，われに来たれ。」と仰せられた。天地は（答えて），『わたしたちは喜んで参上します。』と申し上げた</div>' +
...
'<p><a href="https://ja.wikipedia.org/wiki/%E3%82%AC%E3%82%B9%E3%82%B8%E3%83%A3%E3%82%A4%E3%82%A2%E3%83%B3%E3%83%88" target="_blank" rel="noopener noreferrer">参考</a></p>' },
  { text: '<div class="quran-quote">アッラー*が誰かを導くことをお望みになれば、かれはその者の胸を服従（イスラーム*）へと広げて下さる。また、かれが誰かを迷わせることをお望みになれば、かれはその者の胸をひどく狭められる。それは、あたかも（上）空に何とか昇ろうとする¹ようなもの。同様にアッラー*は、信仰しない者たちに穢れ²をお与えになるのだ。</div>' +
...
'<p><a href="https://education.nationalgeographic.org/resource/atmospheric-pressure/" target="_blank" rel="noopener noreferrer">参考</a></p>' },
  { text: '<div class="quran-quote">37.またかれらへの印には，夜がある。われがそれから昼を退かせると，見よ，真っ暗になる。<br>https://quranpedia.net/surah/1/36/book/1976<br>5.かれは灯明（星）をもって，最下層の天を飾り，悪魔たちに対する磔（流星）となし，またかれらのために烈火の懲罰を準備した<br>https://quranpedia.net/surah/1/67/book/1976</div>' +
'<div class="explanation-title">説明</div>' +
'<p>二つの尊い詩句に示されているように、宇宙は深い闇に包まれており、私たちは地球の表面で明るい日中であっても同様です。科学者たちは、太陽系に属する地球や他の惑星が明るい日中に照らされているのを見てきましたが、その周りの天空は深い闇に覆われています。ムハンマド、神に祝福と平安あれ、の時代に、闇が宇宙の支配的な状態であることを誰が知っていたでしょうか？そして、これらの銀河や星々が、周囲を取り囲む広大な宇宙の闇をほんのわずかに照らすだけの小さな弱いランプであることを、装飾やランプのように見えるだけであるということを、誰が知っていたでしょうか？</p>' },
  { text: '<div class="quran-quote">32.更にわれは，天を屋根とし守護した。それでもかれらは，これらの印から背き去る。</div>' +
'<p><a href="https://quranpedia.net/surah/1/21/book/1976" target="_blank" rel="noopener noreferrer">https://quranpedia.net/surah/1/21/book/1976</a></p>' +
'<div class="explanation-title">説明</div>' +
...
'<p><a href="https://www.space.com/17683-earth-atmosphere.html" target="_blank" rel="noopener noreferrer">参考</a></p>' },
  { text: '<div class="quran-quote">88.あなたは山々を見て堅固であると思うだろう。だがそれは雲が散るように通り過ぎていくのである。それは凡てのものを，完成なされるアッラーの御業である。本当にかれはあなたがたの行うことを熟知なされる</div>' +
...
'<p>私たちはみな、山が固定されていることを知っていますが、もし地球から重力や大気から離れて上昇し、地球の回転を見ると、地球が驚異的な速さで回転しているのを見るでしょう（時速100マイル）、その後、山々が雲のように動いているように見えます。つまり、その動きは固有のものではなく、むしろ地球の動きにリンクしているということです。動かない雲のように、自ら動くのではなく、風によって駆動されています。そして、これが地球の動きの証拠です。</p>' },
  { text: '<div class="quran-quote">22.またわれは豊沃にする風を送り，天から雨を降らせて，それをあなたがたに飲ませる。だがあなたがたはその（宝庫の）管理者ではない。</div>' +
...
'<p>これは、風の利点の1つとして、風が花粉粒子を運び、後で果物になる花を受粉させることができるということが現代科学で証明されています。</p>' },
  { text: '<div class="quran-quote">本当にわが印を信じない者は，やがて火獄に投げ込まれよう。かれらの皮膚が焼け尽きる度に，われは他の皮膚でこれに替え，かれらに（飽くまで）懲罰を味わわせるであろう。誠にアッラーは偉力ならびなく英明であられる。</div>' +
...
'<p>現代科学は、痛みや熱に関連する感覚粒子が皮膚層にのみ存在することを証明しています。そして、皮膚はその下の筋肉や他のものと一緒に焼けるにも関わらず、クルアーンではそれらを言及していません。なぜなら、痛みの感覚は皮膚層に特有のものだからです。</p>' },
  { text: '<div class="quran-quote">また（不信者の状態は），深海の暗黒のようなもので，波がかれらを覆い，その上に（また）波があり，その上を（更に）雲が覆っている。暗黒の上に暗黒が重なる。かれが手を差し伸べても凡んどそれは見られない。アッラーが光を与えられない者には，光はない。</div>' +
...
'<p><a href="https://nexus.jefferson.edu/science-and-technology/what-are-internal-waves-in-the-ocean-and-why-are-they-important/#:~:text=Internal%20waves%20are%20the%20undersea,dioxide%20down%20to%20the%20depths." target="_blank" rel="noopener noreferrer">参考</a></p>' },
  { text: '<div class="quran-quote">あなたがたは見ないか。アッラーは雲を駆り，やがてそれを相い合わせ，さらに固まりにされ，やがて慈雨が，その間から降るのを。また雹を含む，山（のような雲）を天から下し，かれは，御好みの者をそれで撃ち，御好みの者を避けられる。稲妻の閃きは，本当に目を奪おうとする。</div>' +
'<p><a href="https://quranpedia.net/surah/1/24/book/1976" target="_blank" rel="noopener noreferrer">https://quranpedia.net/surah/1/24/book/1976</a></p>' +
'<div class="explanation-title">説明</div>' +
'<p>科学者たちは言います。積乱雲の形成は、風によって押しやられた数個の細胞、綿の塊のようなものから始まり、それらが合体して高さ45,000フィートに達する巨大な山のような雲を形成します。雲の頂部はその基部と比べて非常に寒く、この温度差のために渦巻が生成され、雲の中で雹が形成されることにつながります。山型の雲の頂点は、まばゆい火花を放つ電気放電を引き起こし、これが空中のパイロットに一時的な失明と呼ばれるものをもたらします。そして、これがまさにクルアーンの一節で描写されていることです。</p>' },
  { text: '<div class="quran-quote">12.われは泥の精髄から人間を創った。<br>13.次に，われはかれを精液の一滴として，堅固な住みかに納めた。<br>14.それからわれは，その精滴を一つの血の塊に創り，次にその塊から肉塊を創り，次いでその肉塊から骨を創り，次に肉でその骨を覆い，それからかれを外の生命体に創り上げた。ああ，何と素晴しいアッラー，最も優れた創造者であられる。</div>' +
...
'<p>妊娠7週目が終わる頃には、胎児形成の段階が終了し、その形は胎児に似るようになります。成長し、成長を完了し、身長と体重を増やし、おなじみの形になるために、少しの時間が必要です。</p>' },
  {  text: '<div class="quran-quote">14.仮令われがかれらのために天の門を開いて，（随時）かれらを登らせようとしても，<br>15.かれらは必ず，「わたしたちの目は本当に眩んでしまった。いやわたしたちは魔法にかけられている。」と言うであろう。</div>' +
'<p><a href="https://quranpedia.net/surah/1/15/book/1976" target="_blank" rel="noopener noreferrer">https://quranpedia.net/surah/1/15/book/1976</a></p>' +
'<div class="explanation-title">説明</div>' +
...
'<p>聖クルアーンは、科学がそれを発見する前に、空を通って上昇する者を、目が曇った者に例え、彼がもはや何も見えず、完全な暗闇と全くの暗闇しか見ないようにしました。あるいは、彼を魔法にかかった者に例え、周りで起こっていることを理解しなくなった者に例えました。これらの比喩の両方が、最初の宇宙飛行士が昼光の範囲を超え、宇宙の暗闇に入った時に起こったことを正確に表現しています。そして、彼らはクルアーンの詩が私たちに伝えたこととほぼ同じ表現をした、それについての知識なしに。</p>'},
  {  text: '<div class="quran-quote">41.アッラーを差し置いて外の主人を取る者を譬えれば，（自分で自分の）家を造る蜘蛛のようなものである。本当に家の中でも最も弱いのは，蜘蛛の家である。かれらに分っていたならば，よかったのに。</div>' +
...
'<p><a href=\"https://www.quora.com/How-do-astronauts-see-in-space-since-it-is-completely-black-there#:~:text=It\'s%20not%20black%20in%20space,angle)%20or%20artificially%20with%20lights.\" target=\"_blank\" rel=\"noopener noreferrer\">参考</a></p>'
  ...
  { text: 'コンテンツはここまでです。ウェブサイトをご利用いただきありがとうございます。イスラムとその奇跡についての理解を深める一助となれば幸いです。さらにご質問がある場合や、イスラムについてもっと学びたい場合は、地域のイスラムセンターにお問い合わせいただくか、信頼できる情報源をオンラインで検索してください。\n\n平和あれ。' }
];
